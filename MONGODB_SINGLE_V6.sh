...
#
#
# mkdir -p /home/ubuntu && cd /home/ubuntu && rm -rf MONGODB_SINGLE_V6 && nano MONGODB_SINGLE_V6
# chmod u+x MONGODB_SINGLE_V6 && ./MONGODB_SINGLE_V6
...
# PRIMARY : mongodb://UNDEFINED:2022UNDEFINED*20221216*X3@ls.prod.db-pri.port.web.id:6000?authSource=admin
# SECONDARY : mongodb://UNDEFINED:2022UNDEFINED*20221216*X3@ls.prod.db-sec.port.web.id:6000?authSource=admin
# ARBITER : mongodb://UNDEFINED:2022UNDEFINED*20221216*X3@ls.prod.db-arb.port.web.id:6000?authSource=admin

# mongodb://UNDEFINED:2022UNDEFINED*20221216*X3@ls.prod.db-pri.port.web.id:6000,ls.prod.db-sec.port.web.id:6000?authSource=admin&replicaSet=UNDEFINED-REPSET


# PRIMARY : mongodb://UNDEFINED:2022UNDEFINED*20221216*X3@192.168.18.13:6000?authSource=admin
...
# ------------------------------V4.4
# mongo admin -u "UNDEFINED" -p "2022UNDEFINED*20221216*X3"
# ------------------------------V4.4
# ------------------------------V5 +
# mongosh admin -u "UNDEFINED" -p "2022UNDEFINED*20221216*X3"
# ------------------------------V5 +
# use admin
